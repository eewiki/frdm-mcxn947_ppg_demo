...
#  set(CONFIG_USE_middleware_tfm_s_frdmmcxn947 true)

#  # description: TFM CMSIS Flash IAP N4A driver
#  set(CONFIG_USE_middleware_tfm_flash_iap_n4a true)
...
#  set(CONFIG_USE_middleware_tfm_ns_frdmmcxn947 true)
...
#  # description: TFM Library board config
#  set(CONFIG_USE_middleware_tfm_s_mcxn9xxevk true)

#  # description: TFM Non Secure board configuration
#  set(CONFIG_USE_middleware_tfm_ns_mcxn9xxevk true)
...
#  # description: NXP Safety IEC60730B Library srecord tool
#  set(CONFIG_USE_middleware_safety_srecord true)
...
include_if_use(component_power_manager_MCXN94x.MCXN947)
include_if_use(component_power_manager_core.MCXN947)
...
include_if_use(middleware_safety_srecord)
...
include_if_use(middleware_tfm_flash_iap_n4a)
include_if_use(middleware_tfm_flash_mcxn)
include_if_use(middleware_tfm_lpuart)
include_if_use(middleware_tfm_ns)
include_if_use(middleware_tfm_ns_frdmmcxn947)
include_if_use(middleware_tfm_ns_mcxn9xxevk)
...
include_if_use(middleware_tfm_s_frdmmcxn947)
...
include_if_use(middleware_tfm_s_mcxn9xxevk)
