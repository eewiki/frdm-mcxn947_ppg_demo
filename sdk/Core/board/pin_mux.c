...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitPpgPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitPpgPins(void)
{
    ...
    gpio_pin_config_t MAX86916_INT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO5_7 (pin L13)  */
    GPIO_PinInit(BOARD_MAX86916_INT_GPIO, BOARD_MAX86916_INT_PIN, &MAX86916_INT_config);

    /* Interrupt configuration on GPIO5_7 (pin L13): Interrupt on falling edge */
    GPIO_SetPinInterruptConfig(BOARD_MAX86916_INT_GPIO, BOARD_MAX86916_INT_PIN, kGPIO_InterruptFallingEdge);
    ...
    /* EFT detect interrupts configuration on PORT5_ */
    PORT_DisableEFTDetectInterrupts(PORT5, 0x80u);
